...
async function makeOffer() {
	const args: TypedValue[] = [
		BytesValue.fromUTF8(WEGLD_TOKEN_ID), 		// from_token_id
		new BigUIntValue(convertEsdtToWei(10, WEGLD_TOKEN_DECIMALS)),	// from_amount
		BytesValue.fromUTF8('makeOffer'),				// functional name
		BytesValue.fromUTF8(USDC_TOKEN_ID), 		// to_token_id
		new BigUIntValue(convertEsdtToWei(300, USDC_TOKEN_DECIMALS)),	// to_amount
		// new BigUIntValue(convertEsdtToWei(100, USDC_TOKEN_DECIMALS)),	// min_to_amount_per_accept - this is optional argument
	];
